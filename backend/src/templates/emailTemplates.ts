...
function row(label: string, value: string, borderTop = true): string {
...
const TRANSACTION_CONFIRMATION: TemplateDefinition = {
...
const DEPOSIT: TemplateDefinition = {
...
const WITHDRAWAL: TemplateDefinition = {
